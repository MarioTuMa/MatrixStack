...
def parse_file( fname, edges, polygons, matrixStack, screen, color ):
    ...
    while c < len(lines):
        ...
        if line == 'sphere':
            ...
            matrix_mult(matrixStack[-1], polygons)
            ...
            add_circle(edges,
                       float(args[0]), float(args[1]), float(args[2]),
                       float(args[3]), step)
            matrix_mult(matrixStack[-1], edges)
            ...
            matrix_mult( matrixStack[-1], t)
            matrixStack.pop()
            matrixStack.append(t)
            ...
            temp = matrixStack[-1].copy()
            #print(temp)
            matrixStack.append(temp)
